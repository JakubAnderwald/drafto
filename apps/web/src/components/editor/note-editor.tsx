  ...
  return (
    <div data-testid="editor-scroll-container" className="min-h-0 flex-1 overflow-y-auto">
      {uploadError && (
        <div
          role="alert"
          data-testid="note-editor-upload-error"
          className="bg-error-bg text-error-text mx-4 mt-2 flex items-start justify-between gap-2 rounded-lg px-4 py-3 text-sm"
        >
