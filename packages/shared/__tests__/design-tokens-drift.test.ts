...
describe("design tokens drift — globals.css vs @drafto/shared", () => {
  ...
  describe("semantic tokens — light mode (:root)", () => {
    const lightCases: Array<[string, string]> = [
      ...
      ["--sidebar-bg", semanticLight.sidebarBg],
      ["--sidebar-hover", semanticLight.sidebarHover],
      ["--sidebar-active", semanticLight.sidebarActive],
      ["--sidebar-active-text", semanticLight.sidebarActiveText],
      ...
      ["--error-hover", semanticLight.errorHover],
  ...
  describe("semantic tokens — dark mode (.dark)", () => {
    const darkCases: Array<[string, string]> = [
      ...
      ["--sidebar-bg", semanticDark.sidebarBg],
      ["--sidebar-hover", semanticDark.sidebarHover],
      ["--sidebar-active", semanticDark.sidebarActive],
      ["--sidebar-active-text", semanticDark.sidebarActiveText],
      ...
      ["--error-hover", semanticDark.errorHover],
