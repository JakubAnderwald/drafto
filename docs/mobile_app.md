...
- [ ] 1.1 — Initialize Expo project in `apps/mobile/` with TypeScript
...
- [ ] 3.1 — Supabase data layer (typed query functions for notebooks, notes, trash)
- [ ] 3.2 — Notebooks list screen (fetch, create, rename, delete)
