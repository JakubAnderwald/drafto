...
- [x] 4-CP — **Checkpoint**: Run full suite locally. If green, check this off, commit, and exit.
- [x] 4-PUSH — **Push**: Run `/push` to PR. Address any review comments/failures automatically. Once `/push` succeeds, check this off and exit.
...
- [x] 7-PUSH — **Push**: Run `/push` to PR. Once successful, check this off, commit, and output "PROJECT COMPLETE".
