...
| `realtime-support-agent-plan.md`     | Multi-phase plan (A–H) for the real-time support agent, all phases shipped | [ADR 0024](../adr/0024-realtime-support-agent.md) + [`../features/support-agent.md`](../features/support-agent.md)                |
